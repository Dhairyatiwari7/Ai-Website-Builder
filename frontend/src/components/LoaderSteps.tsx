...
const steps=[
  ...
  {icon : CircleIcon,label : "Finilizing Your Website..."},
]
...
const LoaderSteps = () => {
  ...
  return ( 
    <div className="w-full h-full flex flex-col items-center justify-center bg-gray-950 relative overflow-hidden text-white">
      ...
      <p className="mt-8 text-lg font-light text-white/90 text-wide
        transition-all duration-700 ease-in-out opacity-100" key={current}>{steps[current].lablel}</p>
